...
public class encodeVideo {
	public encodeVideo(int frames, double vidRate, long sTime, long[] timeStamps){
		...
		writer = ToolFactory.makeWriter("processingSketch.h264");
		writer.open();
		writer.setForceInterleave(true);
		writer.addVideoStream(0,0,IRational.make((double)vidRate),800,400);
		BufferedImage bgr = new BufferedImage(800,400,BufferedImage.TYPE_3BYTE_BGR);
